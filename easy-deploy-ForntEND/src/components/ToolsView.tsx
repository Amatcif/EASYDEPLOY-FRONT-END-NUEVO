...
import { Archive, Command, Database, FileText, FolderOpen, Terminal, Users, Wrench } from 'lucide-react';
...
const toolSections = [
  {
    ...
    items: [
      ...
      { label: 'Forzar políticas GPO', detail: 'Ejecutar gpupdate /force mediante el motor interno', action: 'tools.gpo_force', icon: Wrench },
    ],
  },
  {
    title: 'Utilidades',
      ...
      >
        <div>
          ...
          <p className="text-xs" style={{ color: 'var(--theme-text-secondary)' }}>
            Accesos administrativos reales del motor interno. No incluye pruebas simuladas ni testers genéricos.
          </p>
        </div>
        <div
              ...
              {section.items.map((item) => {
                ...
                return (
                  <button
                    ...
                    className="w-full text-left p-3 rounded-lg border flex items-center gap-3 transition-colors hover:opacity-90 cursor-pointer"
